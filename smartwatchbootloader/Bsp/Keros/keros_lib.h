...
#define MAX_AES_BUFFER_SIZE			16
	...
	/**
	 * name : uint8_t keros_eeprom_read( uint8_t page, uint8_t *r_data, uint8_t encrytion )
	...
	uint8_t keros_eeprom_read( uint32_t password, uint8_t page, uint8_t *r_data, uint8_t encrytion );

	/**
	 * name : uint8_t keros_eeprom_write( uint8_t page, uint8_t *w_data, uint8_t encrytion )
	 ...
	 *
	 */
	uint8_t keros_eeprom_write( uint32_t password, uint8_t page, uint8_t *w_data, uint8_t encrytion );

	/**
	 * name : keros_eeprom_pwchg( uint8_t page, uint32_t old_password, uint32_t new_password )
   ...
   * @param	 old_password : old password
	 ...
	 *
	 */
	uint8_t keros_eeprom_pwchg( uint8_t page, uint32_t old_password, uint32_t new_password );



	/**
	 * name : uint8_t keros_req_enc_dec(uint8_t *req_data, uint8_t *result_data, uint8_t mode);
	 ...
	 *
	 */
	uint8_t keros_req_enc_dec( uint8_t * req_data, uint8_t * result_data, uint8_t mode );
	...
	/**
	 * name : uint8_t keros_set_aes_key_size(uint8_t aes_key_size);
	...
	/**
	 * name : uint8_t keros_read_inkjet_counter(uint16_t *counter_value);
	...
	/**
	 * name : uint8_t keros_inc_inkjet_counter(void);
	...
	/**
	 * name : uint8_t keros_powersave(uint8_t cmd, uint32_t time)
	 * @brief	: power off
	 ...
	 *
	 */
	uint8_t keros_powersave(uint8_t cmd, uint32_t time);
	 ...
	 *
	 */
   uint8_t keros_authentication(uint8_t aes_key_size, uint32_t seed, uint8_t *indata, uint8_t *odata);
