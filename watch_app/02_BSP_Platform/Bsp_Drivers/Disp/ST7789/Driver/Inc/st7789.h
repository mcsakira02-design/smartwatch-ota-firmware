...
/* Basic operations */
#define ST7789_RST_Clr() core_gpio_write_pin(CORE_GPIO_LCD_RESET, CORE_GPIO_PIN_RESET)
#define ST7789_RST_Set() core_gpio_write_pin(CORE_GPIO_LCD_RESET, CORE_GPIO_PIN_SET)

#define ST7789_DC_Clr() core_gpio_write_pin(CORE_GPIO_LCD_DC, CORE_GPIO_PIN_RESET)
#define ST7789_DC_Set() core_gpio_write_pin(CORE_GPIO_LCD_DC, CORE_GPIO_PIN_SET)
#ifndef CFG_NO_CS
#define ST7789_Select() core_gpio_write_pin(CORE_GPIO_LCD_CS, CORE_GPIO_PIN_RESET)
#define ST7789_UnSelect() core_gpio_write_pin(CORE_GPIO_LCD_CS, CORE_GPIO_PIN_SET)
#else
...
/* Graphical functions. */
void ST7789_DrawLine(uint16_t x1, uint16_t y1, uint16_t x2, \
                     uint16_t y2, uint16_t color);
void ST7789_DrawRectangle(uint16_t x1, uint16_t y1, uint16_t x2, \
                          uint16_t y2, uint16_t color);
void ST7789_DrawCircle(uint16_t x0, uint16_t y0, uint8_t r, uint16_t color);
void ST7789_DrawImage(uint16_t x, uint16_t y, uint16_t w, \
                      uint16_t h, const uint16_t *data);
void ST7789_InvertColors(uint8_t invert);

/* Text functions. */
void ST7789_WriteChar(uint16_t x, uint16_t y, char ch, font_def_t font, \
                      uint16_t color, uint16_t bgcolor);
void ST7789_WriteString(uint16_t x, uint16_t y, const char *str, \
                        font_def_t font, uint16_t color, uint16_t bgcolor);

/* Extented Graphical functions. */
void ST7789_DrawFilledRectangle(uint16_t x, uint16_t y, uint16_t w, \
